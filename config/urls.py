...
urlpatterns = [path("", TemplateView.as_view(template_name="pages/home.html"), name="home"),
               path("ISA/", include("isa_poll.urls", namespace='isa_poll'), name="home"),
               # Django Admin, use {% url 'admin:index' %}
                  path(settings.ADMIN_URL, admin.site.urls), # User management
                  path("users/", include("digitale_esa.users.urls", namespace="users")),
                  path("accounts/", include("allauth.urls")), # Your stuff: custom urls includes go here
